...
LegalTerms.ListStore = new Ext.data.Store({
    ...
    data: [
        { lTerm: "Ab initio Razaaa oneee",      lDefinition: '"From the start" - In Latin  ' },
        ...
        { lTerm: "Act of God Razaa twooo",       lDefinition: "An event arising (PS. SECOND EDT lol) from natural causes, without human intervention (e.g.  floods or earthquakes). Insurance policies often exclude acts of God." },
